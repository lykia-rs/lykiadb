...
impl<'v> PlanExecutor {
    ...
    pub fn execute_plan(&mut self, plan: Plan<'v>, exec_ctx: &'v ExecutionContext<'v>) -> Result<RVs<'v>, ExecutionError> {
    ...
    pub fn execute_node(&mut self, node: Node<'v>, exec_ctx: &'v ExecutionContext<'v>) -> Result<RVs<'v>, ExecutionError> {
        match node {
